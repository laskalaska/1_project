...
console.log(`Array of phone numbers of users with a balance of more than $2,000:`);
console.log(phoneNumbers);
let finalSum = sumBalance.toLocaleString();
console.log(`Sum of all users balances: $${finalSum}`);